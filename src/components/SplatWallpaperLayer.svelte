<script lang="ts">
  /**
   * 全屏 3D Gaussian Splatting 环境壁纸层
   * 自 my-second-brain BackgroundPlyLayer.svelte 复制，import 路径已独立化
   */
  import { onMount } from 'svelte';
  import { createGS3Wallpaper, type GS3WallpaperStatus } from '../core/gs3-wallpaper';
  import { isMobileUa } from '../core/is-mobile';
  ...
  let posterOnly = $state(typeof navigator !== 'undefined' ? isMobileUa() : false);
...
<div
  ...
  class:is-ready={ready && !posterOnly}
